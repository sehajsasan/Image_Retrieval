...
data_dict = torch.load('/notebooks/Image_Retrieval/EasyPositiveHardNegative-master/data_dict_emb1.pth'.format(Data))
...
for epoch in range(num_epochs+1): 
    ...
    if epoch>0:  
        ...
        # print('loss', L_data/N_data, epoch)
        # adjust the learning rate
        scheduler.step()
    if epoch%5== 0:
        torch.save(model.cpu().state_dict(), dst + f'model_state_dict_{model_name}{epoch}.pth')
